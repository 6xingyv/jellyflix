...
public val Icons.Regular.MailRead: ImageVector
    get() {
        if (presentation.icons.regular._mailRead != null) {
            return presentation.icons.regular._mailRead!!
        }
        presentation.icons.regular._mailRead = fluentIcon(name = "Regular.MailRead") {
            fluentPath {
                moveTo(3.1f, 8.17f)
