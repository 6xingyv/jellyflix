...
public val Icons.Regular.TaskListSquareRtl: ImageVector
    get() {
        if (presentation.icons.regular._taskListSquareRtl != null) {
            return presentation.icons.regular._taskListSquareRtl!!
        }
        presentation.icons.regular._taskListSquareRtl = fluentIcon(name = "Regular.TaskListSquareRtl") {
            fluentPath {
                moveTo(7.25f, 14.0f)
