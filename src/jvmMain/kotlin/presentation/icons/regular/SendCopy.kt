...
public val Icons.Regular.SendCopy: ImageVector
    get() {
        if (_sendCopy != null) {
            return _sendCopy!!
        }
        _sendCopy = fluentIcon(name = "Regular.SendCopy") {
            fluentPath {
                moveTo(19.75f, 11.5f)
                curveToRelative(0.38f, 0.0f, 0.7f, 0.28f, 0.74f, 0.65f)
                lineToRelative(0.01f, 0.1f)
                verticalLineToRelative(5.0f)
                arcTo(4.75f, 4.75f, 0.0f, false, true, 15.97f, 22.0f)
                lineTo(8.25f, 22.0f)
                curveToRelative(-0.98f, 0.0f, -1.81f, -0.63f, -2.12f, -1.5f)
                lineTo(15.93f, 20.5f)
                arcTo(3.25f, 3.25f, 0.0f, false, false, 19.0f, 17.42f)
