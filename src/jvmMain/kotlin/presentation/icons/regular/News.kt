...
public val Icons.Regular.News: ImageVector
    get() {
        if (presentation.icons.regular._news != null) {
            return presentation.icons.regular._news!!
        }
        presentation.icons.regular._news = fluentIcon(name = "Regular.News") {
            fluentPath {
                moveTo(18.75f, 20.0f)
                lineTo(5.25f, 20.0f)
                ...
                arcToRelative(0.75f, 0.75f, 0.0f, false, true, -0.74f, -0.75f)
                verticalLineToRelative(-3.5f)
                curveToRelative(0.0f, -0.41f, 0.33f, -0.75f, 0.75f, -0.75f)
                horizontalLineToRelative(3.5f)
                close()
