    ...
    get() {
        ...
        _moviesAndTv = fluentIcon(name = "Filled.MoviesAndTv") {
            fluentPath {
                ...
                close()
                moveTo(11.03f, 5.23f)
                lineToRelative(-2.72f, 0.78f)
                lineToRelative(-1.71f, 3.1f)
                lineToRelative(2.72f, -0.79f)
                lineToRelative(1.7f, -3.09f)
                close()
                moveTo(15.79f, 3.87f)
                lineToRelative(-2.72f, 0.78f)
                lineToRelative(-1.71f, 3.09f)
                lineToRelative(2.71f, -0.78f)
                lineToRelative(1.72f, -3.1f)
                close()
                moveTo(17.63f, 3.64f)
                lineToRelative(-1.52f, 2.74f)
                lineToRelative(2.57f, -0.74f)
                lineToRelative(-0.34f, -1.2f)
