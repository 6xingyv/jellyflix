...
public val Icons.Filled.Diversity: ImageVector
    get() {
        if (presentation.icons.filled._diversity != null) {
            return presentation.icons.filled._diversity!!
        }
        presentation.icons.filled._diversity = fluentIcon(name = "Filled.Diversity") {
            fluentPath {
                moveTo(16.0f, 3.0f)
