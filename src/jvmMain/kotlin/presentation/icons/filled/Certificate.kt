...
public val Icons.Filled.Certificate: ImageVector
    get() {
        if (presentation.icons.filled._certificate != null) {
            return presentation.icons.filled._certificate!!
        }
        presentation.icons.filled._certificate = fluentIcon(name = "Filled.Certificate") {
            fluentPath {
                moveTo(15.0f, 18.0f)
