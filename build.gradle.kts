...
kotlin {
    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                // Moko
                implementation("dev.icerock.moko:resources:0.21.1")
            }
        }
...
//                implementation("com.squareup.retrofit2:converter-gson:2.9.0")
                // Moko
                implementation("dev.icerock.moko:resources:0.21.1")
                implementation("dev.icerock.moko:resources-compose:0.21.1")
                // Jellyfin SDK
                implementation("org.jellyfin.sdk:jellyfin-core:1.4.1")
